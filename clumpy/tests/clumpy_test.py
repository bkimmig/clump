...
def simulation1():
    ...
    # use the algorithm
    rv = clumpy.EM(
        velocity_data, velocity_error_data, radius_data,
...
###############################################################################
# Simulation 2: Radius and Velocity and a
# Second Parameter (usually Metallicity).
